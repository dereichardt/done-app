...
export function HomeSkinnyTaskRow({
  ...
  return (
    <div
      className="group relative flex min-w-0 items-center gap-2 rounded-[10px] border px-2 py-2"
      style={{
        borderColor: "var(--app-border)",
        background: rowBg,
      }}
    >
      ...
      <span
        className="min-w-0 flex-1 truncate pr-20 text-sm font-medium"
      ...
      <div
        className="absolute right-1.5 top-1/2 flex -translate-y-1/2 items-center gap-1 rounded-[8px] py-0.5 pl-4 opacity-0 pointer-events-none transition-opacity duration-150 group-hover:opacity-100 group-hover:pointer-events-auto group-focus-within:opacity-100 group-focus-within:pointer-events-auto motion-reduce:transition-none"
        style={{
          background: `linear-gradient(to right, transparent, ${rowBg} 18%)`,
        }}
      >
        <button
          type="button"
