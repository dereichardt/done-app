...
create table if not exists public.internal_initiative_manual_effort_entries (
...
create index if not exists internal_initiative_manual_effort_entries_ini_started_at_idx
...
begin
  if not exists (
    ...
    where schemaname = 'public'
      and tablename = 'internal_initiative_manual_effort_entries'
      and policyname = 'internal_initiative_manual_effort_entries_via_initiative'
  ) then
