...
$cnvs-sys-opacity-overlay: $cnvs-base-opacity-640; // Overlay
$cnvs-sys-opacity-disabled: $cnvs-base-opacity-400; // Disabled states
$cnvs-sys-opacity-zero: $cnvs-base-opacity-0; // Dev only
$cnvs-sys-motion-easing-purposeful-deceleration: $cnvs-base-easing-b-300;
$cnvs-sys-motion-easing-purposeful-acceleration: $cnvs-base-easing-b-200;
$cnvs-sys-motion-easing-purposeful-standard: $cnvs-base-easing-b-100;
...
$cnvs-sys-color-static-gray-stronger: $cnvs-base-palette-slate-800; // Stronger gray
...
$cnvs-sys-space-half: calc($cnvs-base-unit * 0.5); // Mobile only
$cnvs-sys-shape-none: $cnvs-base-size-0; // Full-width and background containers. Fixed navigation containers such as headers, and side-panels.
...
$cnvs-sys-shape-x6: calc($cnvs-base-unit * 6); // (Mobile) Full width sheets that are temporary and modal views
$cnvs-sys-shape-x4: calc($cnvs-base-unit * 4); // (Mobile) Primary containers that house a large amount of other elements and complex information
...
$cnvs-sys-gap-xxl: $cnvs-base-size-800; // Use this for the space between content sections
$cnvs-sys-gap-xl: $cnvs-base-size-400; // Use this for the default spacing between cards, as well as the gutter width used in the large 12-column grid.
$cnvs-sys-gap-lg: $cnvs-base-size-300; // Use this for tighter spacing between cards. Cards are self contained blocks of content.
$cnvs-sys-gap-md: $cnvs-base-size-200; // Use the default inline spacing when other gap tokens may not fit.
$cnvs-sys-gap-sm: $cnvs-base-size-100; // Horizontal space between pills, tighter space between buttons, inline icon to text, segmented controls.
$cnvs-sys-gap-xs: $cnvs-base-size-50; // Compact spacing from icon to text, labels to inputs, between tab items.
$cnvs-sys-padding-xxl: $cnvs-base-size-400; // Padding used around Modal and Large Button content
$cnvs-sys-padding-xl: $cnvs-base-size-300; // Padding used around Card and Medium Button content
$cnvs-sys-padding-lg: $cnvs-base-size-250; // Large padding, used in Medium Buttons with Icons
$cnvs-sys-padding-md: $cnvs-base-size-200; // Default padding used for components used around Small Button content.
...
$cnvs-sys-line-height-heading-lg: $cnvs-base-size-500;
...
$cnvs-sys-line-height-subtext-sm: $cnvs-base-size-200;
$cnvs-sys-font-size-title-lg: $cnvs-base-size-700;
$cnvs-sys-font-size-title-md: $cnvs-base-size-600;
$cnvs-sys-font-size-title-sm: $cnvs-base-size-500;
$cnvs-sys-font-size-heading-lg: $cnvs-base-size-400;
$cnvs-sys-font-size-heading-md: $cnvs-base-size-350;
$cnvs-sys-font-size-heading-sm: $cnvs-base-size-300;
$cnvs-sys-font-size-body-lg: $cnvs-base-size-250;
$cnvs-sys-font-size-body-md: $cnvs-base-size-225;
$cnvs-sys-font-size-body-sm: $cnvs-base-size-200;
$cnvs-sys-font-size-subtext-lg: $cnvs-base-size-175;
$cnvs-sys-font-size-subtext-md: $cnvs-base-size-150;
...
.cnvs-sys-type-subtext-sm {
  font-family: $cnvs-sys-font-family-default;
  font-weight: $cnvs-sys-font-weight-normal;
  line-height: $cnvs-sys-line-height-subtext-sm;
  font-size: $cnvs-sys-font-size-subtext-sm;
  letter-spacing: $cnvs-sys-letter-spacing-subtext-sm;
}

.cnvs-sys-type-subtext-md {
  font-family: $cnvs-sys-font-family-default;
  font-weight: $cnvs-sys-font-weight-normal;
  line-height: $cnvs-sys-line-height-subtext-md;
  font-size: $cnvs-sys-font-size-subtext-md;
  letter-spacing: $cnvs-sys-letter-spacing-subtext-md;
}

.cnvs-sys-type-subtext-lg {
  font-family: $cnvs-sys-font-family-default;
  font-weight: $cnvs-sys-font-weight-normal;
  line-height: $cnvs-sys-line-height-subtext-lg;
  font-size: $cnvs-sys-font-size-subtext-lg;
  letter-spacing: $cnvs-sys-letter-spacing-subtext-lg;
}
...
.cnvs-sys-type-body-sm {
  font-family: $cnvs-sys-font-family-default;
  font-weight: $cnvs-sys-font-weight-normal;
  line-height: $cnvs-sys-line-height-body-sm;
  font-size: $cnvs-sys-font-size-body-sm;
  letter-spacing: $cnvs-sys-letter-spacing-body-sm;
}
